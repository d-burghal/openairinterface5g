 ...
 * @param rx_size_max     Inner dimension of ch_maga/ch_magb/ch_magc/rho arrays.
 ...
 * @param ch_maga         Output magnitude array for threshold 'a' [nb_layers][rx_size_max]
 * @param ch_magb         Output magnitude array for threshold 'b' [nb_layers][rx_size_max]
 * @param ch_magc         Output magnitude array for threshold 'c' [nb_layers][rx_size_max]
 * @param rxComp          Output compensated signal; row [l * nb_rx_ant] holds the MRC result
 *                        for layer l at offset [symbol * buffer_length]
 * @param rho             Tx-correlation matrix [nb_layers][nb_layers][rx_size_max], or NULL
...
void nr_channel_compensation(uint32_t buffer_length,
                             ...
                             c16_t ch_maga[nb_layers][rx_size_max],
                             c16_t ch_magb[nb_layers][rx_size_max],
                             c16_t ch_magc[nb_layers][rx_size_max],
                             c16_t **rxComp,
                             c16_t (*rho)[nb_layers][rx_size_max],
                             int mod_order,
                             uint32_t symbol,
