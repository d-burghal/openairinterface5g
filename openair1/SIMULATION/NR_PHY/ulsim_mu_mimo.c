...
int main(int argc, char *argv[])
{
  ...
  NR_CellGroupConfig_t *scg = get_default_secondaryCellGroup(scc, UE_Capability_nr, uecap_fs_ids, 0, 1, &conf, uid, ssb_index);
  ...
  for (int u = 0; u < NUM_UE; u++) {
    nr_mac_add_test_ue(RC.nrmac[0], n_rnti + u, scg);
  }
